...
export function TaskDetail({ baseUrl, token, task, onDone, onCancel }: Props) {
  ...
  return (
    <form className="shell" onSubmit={submit}>
      ...
      <p className="payout" style={{ marginTop: 20 }}>
        ${task.payoutUsdc} USDC
      </p>
      ...
      />
      <p className="hint">
        Describe the evidence, not your conclusion. Reviewers are paid for answering, not for
        agreeing with each other — report what you actually see.
      </p>
